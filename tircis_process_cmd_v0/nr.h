...
void gaussj_d(double **a, int n, double **b, int m);
...
void lfit_d(double x[], double y[], double sig[], int ndat, double a[], int ia[],
...
void svdfit_d(double x[], double y[], double sig[], int ndata, double a[],
